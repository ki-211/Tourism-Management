...
export interface Message{id:number;userId:number;nickname:string;content:string;createdAt:string} export interface Photo{id:number;url:string;uploaderId:number;uploaderName:string;createdAt:string;deletable:boolean}
