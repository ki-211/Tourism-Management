...
public class WebSocketConfig implements WebSocketConfigurer {
    ...
    public WebSocketConfig(RoomWebSocketHandler handler, WebSocketTicketService tickets, CorsProperties cors) { this.handler = handler; this.tickets = tickets; this.cors = cors; }
    @Override public void registerWebSocketHandlers(WebSocketHandlerRegistry registry) {
        registry.addHandler(handler, "/ws").addInterceptors(new TicketInterceptor(tickets))
    ...
    private static class TicketInterceptor implements HandshakeInterceptor {
        private final WebSocketTicketService tickets; TicketInterceptor(WebSocketTicketService tickets) { this.tickets = tickets; }
        @Override public boolean beforeHandshake(ServerHttpRequest req, ServerHttpResponse res, WebSocketHandler h, Map<String,Object> attrs) {
            try {
                ...
                attrs.put("userId", tickets.consume(ticket)); return true;
