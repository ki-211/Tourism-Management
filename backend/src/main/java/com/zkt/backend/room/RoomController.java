...
public class RoomController {
    ...
    @DeleteMapping("/photos/{photoId}") ApiResponse<Void> deletePhoto(@AuthenticationPrincipal UserPrincipal p,@PathVariable Long activityId,@PathVariable Long photoId){service.deletePhoto(p.id(),activityId,photoId);return ApiResponse.ok("照片已删除",null);}
