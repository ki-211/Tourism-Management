...
const _sfc_main = {
  ...
  beforeCreate() {
    common_vendor.index.loadFontFace({
      ...
      source: 'url("' + common_vendor.config.iconUrl + '")',
      success() {
      },
      fail() {
    ...
    if (common_vendor.config.customIcon.family) {
      common_vendor.index.loadFontFace({
        family: common_vendor.config.customIcon.family,
        source: 'url("' + common_vendor.config.customIcon.url + '")',
        success() {
        },
        fail() {
  ...
  computed: {
    ...
    icon() {
      if (this.customPrefix !== "uicon") {
        return common_vendor.config.customIcons[this.name] || this.name;
      }
