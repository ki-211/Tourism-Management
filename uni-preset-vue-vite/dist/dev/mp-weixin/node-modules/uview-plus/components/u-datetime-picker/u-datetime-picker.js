    ...
    updateIndexs(value) {
      ...
      if (this.mode === "time") {
        ...
        values = [
          ...
          // 月份补0
          formatter("month", common_vendor.padZero(common_vendor.dayjs(value).month() + 1))
        ];
        if (this.mode === "date") {
          values.push(formatter("day", common_vendor.padZero(common_vendor.dayjs(value).date())));
        }
        if (this.mode === "datetime") {
          values.push(formatter("day", common_vendor.padZero(common_vendor.dayjs(value).date())), formatter("hour", common_vendor.padZero(common_vendor.dayjs(value).hour())), formatter("minute", common_vendor.padZero(common_vendor.dayjs(value).minute())));
        }
      }
