...
function setConfig$1(configs) {
  ...
  shallowMerge(props$p, configs.props || {});
...
function setConfig(configs) {
  ...
  index.shallowMerge(props$p, configs.props || {});
...
const props$o = defineMixin({
  props: {
    ...
    type: {
      type: String,
      default: () => props$p.input.type
    },
    // 如果 textarea 是在一个 position:fixed 的区域，需要显示指定属性 fixed 为 true，
    // 兼容性：微信小程序、百度小程序、字节跳动小程序、QQ小程序
    fixed: {
      type: Boolean,
      default: () => props$p.input.fixed
    },
    // 是否禁用输入框
    disabled: {
      type: Boolean,
      default: () => props$p.input.disabled
    },
    // 禁用状态时的背景色
    disabledColor: {
      type: String,
      default: () => props$p.input.disabledColor
    },
    // 是否显示清除控件
    clearable: {
      type: Boolean,
      default: () => props$p.input.clearable
    },
    // 是否密码类型
    password: {
      type: Boolean,
      default: () => props$p.input.password
    },
    // 最大输入长度，设置为 -1 的时候不限制最大长度
    maxlength: {
      type: [String, Number],
      default: () => props$p.input.maxlength
    },
    // 	输入框为空时的占位符
    placeholder: {
      type: String,
      default: () => props$p.input.placeholder
    },
    ...
    showWordLimit: {
      type: Boolean,
      default: () => props$p.input.showWordLimit
    },
    ...
    confirmType: {
      type: String,
      default: () => props$p.input.confirmType
    },
    // 点击键盘右下角按钮时是否保持键盘不收起，H5无效
    confirmHold: {
      type: Boolean,
      default: () => props$p.input.confirmHold
    },
    // focus时，点击页面的时候不收起键盘，微信小程序有效
    holdKeyboard: {
      type: Boolean,
      default: () => props$p.input.holdKeyboard
    },
    // 自动获取焦点
    // 在 H5 平台能否聚焦以及软键盘是否跟随弹出，取决于当前浏览器本身的实现。nvue 页面不支持，需使用组件的 focus()、blur() 方法控制焦点
    focus: {
      type: Boolean,
      default: () => props$p.input.focus
    },
    // 键盘收起时，是否自动失去焦点，目前仅App3.0.0+有效
    autoBlur: {
      type: Boolean,
      default: () => props$p.input.autoBlur
    },
    // 是否去掉 iOS 下的默认内边距，仅微信小程序，且type=textarea时有效
    disableDefaultPadding: {
      type: Boolean,
      default: () => props$p.input.disableDefaultPadding
    },
    // 指定focus时光标的位置
    cursor: {
      type: [String, Number],
      default: () => props$p.input.cursor
    },
    // 输入框聚焦时底部与键盘的距离
    cursorSpacing: {
      type: [String, Number],
      default: () => props$p.input.cursorSpacing
    },
    // 光标起始位置，自动聚集时有效，需与selection-end搭配使用
    selectionStart: {
      type: [String, Number],
      default: () => props$p.input.selectionStart
    },
    // 光标结束位置，自动聚集时有效，需与selection-start搭配使用
    selectionEnd: {
      type: [String, Number],
      default: () => props$p.input.selectionEnd
    },
    // 键盘弹起时，是否自动上推页面
    adjustPosition: {
      type: Boolean,
      default: () => props$p.input.adjustPosition
    },
    // 输入框内容对齐方式，可选值为：left|center|right
    inputAlign: {
      type: String,
      default: () => props$p.input.inputAlign
    },
    // 输入框字体的大小
    fontSize: {
      type: [String, Number],
      default: () => props$p.input.fontSize
    },
    // 输入框字体颜色
    color: {
      type: String,
      default: () => props$p.input.color
    },
    // 输入框前置图标
    prefixIcon: {
      type: String,
      default: () => props$p.input.prefixIcon
    },
    // 前置图标样式，对象或字符串
    prefixIconStyle: {
      type: [String, Object],
      default: () => props$p.input.prefixIconStyle
    },
    // 输入框后置图标
    suffixIcon: {
      type: String,
      default: () => props$p.input.suffixIcon
    },
    // 后置图标样式，对象或字符串
    suffixIconStyle: {
      type: [String, Object],
      default: () => props$p.input.suffixIconStyle
    },
    // 边框类型，surround-四周边框，bottom-底部边框，none-无边框
    border: {
      type: String,
      default: () => props$p.input.border
    },
    // 是否只读，与disabled不同之处在于disabled会置灰组件，而readonly则不会
    readonly: {
      type: Boolean,
      default: () => props$p.input.readonly
    },
    // 输入框形状，circle-圆形，square-方形
    shape: {
      type: String,
      default: () => props$p.input.shape
    },
    // 用于处理或者过滤输入框内容的方法
    formatter: {
      type: [Function, null],
      default: () => props$p.input.formatter
    },
    // 是否忽略组件内对文本合成系统事件的处理
...
const props$n = defineMixin({
  props: {
    ...
    label: {
      type: String,
      default: () => props$p.formItem.label
    },
    // 绑定的值
    prop: {
      type: String,
      default: () => props$p.formItem.prop
    },
    // 绑定的规则
    rules: {
      type: Array,
      default: () => props$p.formItem.rules
    },
    // 是否显示表单域的下划线边框
    borderBottom: {
      type: [String, Boolean],
      default: () => props$p.formItem.borderBottom
    },
    // label的位置，left-左边，top-上边
    labelPosition: {
      type: String,
      default: () => props$p.formItem.labelPosition
    },
    // label的宽度，单位px
    labelWidth: {
      type: [String, Number],
      default: () => props$p.formItem.labelWidth
    },
    // 右侧图标
    rightIcon: {
      type: String,
      default: () => props$p.formItem.rightIcon
    },
    // 左侧图标
    leftIcon: {
      type: String,
      default: () => props$p.formItem.leftIcon
    },
    // 是否显示左边的必填星号，只作显示用，具体校验必填的逻辑，请在rules中配置
    required: {
      type: Boolean,
      default: () => props$p.formItem.required
    },
    leftIconStyle: {
      type: [String, Object],
      default: () => props$p.formItem.leftIconStyle
    }
  }
});
const icons = {
...
const props$k = defineMixin({
  props: {
    ...
    model: {
      type: Object,
      default: () => props$p.form.model
    },
    // 验证规则
    rules: {
      type: [Object, Function, Array],
      default: () => props$p.form.rules
    },
    // 有错误时的提示方式，message-提示信息，toast-进行toast提示
    // border-bottom-下边框呈现红色，none-无提示
    errorType: {
      type: String,
      default: () => props$p.form.errorType
    },
    // 是否显示表单域的下划线边框
    borderBottom: {
      type: Boolean,
      default: () => props$p.form.borderBottom
    },
    // label的位置，left-左边，top-上边
    labelPosition: {
      type: String,
      default: () => props$p.form.labelPosition
    },
    // label的宽度，单位px
    labelWidth: {
      type: [String, Number],
      default: () => props$p.form.labelWidth
    },
    // lable字体的对齐方式
    labelAlign: {
      type: String,
      default: () => props$p.form.labelAlign
    },
    // lable的样式，对象形式
    labelStyle: {
      type: Object,
      default: () => props$p.form.labelStyle
    }
  }
});
...
const props$h = defineMixin({
  props: {
    ...
    inputBorder: {
      type: String,
      default: () => props$p.input.inputBorder
    },
    disabled: {
      type: Boolean,
      default: () => props$p.input.disabled
...
const props$f = defineMixin({
  props: {
    ...
    gap: {
      type: [String, Number],
      default: () => props$p.radioGroup.gap
    }
  }
});
...
const props$e = defineMixin({
  props: {
    ...
    extension: {
      type: Array,
      default: () => props$p.upload.extension
    },
    ...
    autoDelete: {
      type: Boolean,
      default: () => props$p.upload.autoDelete
    },
    // 是否自动上传需要传递action指定地址
    autoUpload: {
      type: Boolean,
      default: () => props$p.upload.autoUpload
    },
    // 自动上传接口地址
    autoUploadApi: {
      type: String,
      default: () => props$p.upload.autoUploadApi
    },
    // 自动上传驱动，local/oss/cos/kodo
    autoUploadDriver: {
      type: String,
      default: () => props$p.upload.autoUploadDriver
    },
    // 自动上传授权接口，比如oss的签名接口。
    autoUploadAuthUrl: {
      type: String,
      default: () => props$p.upload.autoUploadAuthUrl
    },
    // 自动上传携带的header
    autoUploadHeader: {
      type: Object,
      default: () => {
        return props$p.upload.autoUploadHeader;
      }
    },
    // 本地计算视频封面
    getVideoThumb: {
      type: Boolean,
      default: () => props$p.upload.getVideoThumb
    },
    // 自定义自动上传后处理
    customAfterAutoUpload: {
      type: Boolean,
      default: () => props$p.upload.customAfterAutoUpload
    }
  }
});
const props$d = defineMixin({
  props: {
    ...
    urls: {
      type: Array,
      default: () => props$p.album.urls
    },
    // 指定从数组的对象元素中读取哪个属性作为图片地址
    keyName: {
      type: String,
      default: () => props$p.album.keyName
    },
    // 单图时，图片长边的长度
    singleSize: {
      type: [String, Number],
      default: () => props$p.album.singleSize
    },
    // 多图时，图片边长
    multipleSize: {
      type: [String, Number],
      default: () => props$p.album.multipleSize
    },
    // 多图时，图片水平和垂直之间的间隔
    space: {
      type: [String, Number],
      default: () => props$p.album.space
    },
    // 单图时，图片缩放裁剪的模式
    singleMode: {
      type: String,
      default: () => props$p.album.singleMode
    },
    // 多图时，图片缩放裁剪的模式
    multipleMode: {
      type: String,
      default: () => props$p.album.multipleMode
    },
    // 最多展示的图片数量，超出时最后一个位置将会显示剩余图片数量
    maxCount: {
      type: [String, Number],
      default: () => props$p.album.maxCount
    },
    // 是否可以预览图片
    previewFullImage: {
      type: Boolean,
      default: () => props$p.album.previewFullImage
    },
    // 每行展示图片数量，如设置，singleSize和multipleSize将会无效
    rowCount: {
      type: [String, Number],
      default: () => props$p.album.rowCount
    },
    // 超出maxCount时是否显示查看更多的提示
    showMore: {
      type: Boolean,
      default: () => props$p.album.showMore
    },
    // 图片形状，circle-圆形，square-方形
    shape: {
      type: String,
      default: () => props$p.image.shape
    },
    // 圆角，单位任意
    radius: {
      type: [String, Number],
      default: () => props$p.image.radius
    },
    // 自适应换行
    autoWrap: {
      type: Boolean,
      default: () => props$p.album.autoWrap
    },
    // 单位
    unit: {
      type: [String],
      default: () => props$p.album.unit
    },
    // 阻止点击冒泡
    stop: {
      type: Boolean,
      default: () => props$p.album.stop
    }
  }
});
const props$c = defineMixin({
  props: {
    ...
    anchor: {
      type: [String, Number],
      default: () => props$p.listItem.anchor
    }
  }
});
const props$b = defineMixin({
  props: {
    ...
    showScrollbar: {
      type: Boolean,
      default: () => props$p.list.showScrollbar
    },
    // 距底部多少时触发scrolltolower事件
    lowerThreshold: {
      type: [String, Number],
      default: () => props$p.list.lowerThreshold
    },
    // 距顶部多少时触发scrolltoupper事件，非nvue有效
    upperThreshold: {
      type: [String, Number],
      default: () => props$p.list.upperThreshold
    },
    // 设置竖向滚动条位置
    scrollTop: {
      type: [String, Number],
      default: () => props$p.list.scrollTop
    },
    // 控制 onscroll 事件触发的频率，仅nvue有效
    offsetAccuracy: {
      type: [String, Number],
      default: () => props$p.list.offsetAccuracy
    },
    // 启用 flexbox 布局。开启后，当前节点声明了display: flex就会成为flex container，并作用于其孩子节点，仅微信小程序有效
    enableFlex: {
      type: Boolean,
      default: () => props$p.list.enableFlex
    },
    // 是否按分页模式显示List，默认值false
    pagingEnabled: {
      type: Boolean,
      default: () => props$p.list.pagingEnabled
    },
    // 是否允许List滚动
    scrollable: {
      type: Boolean,
      default: () => props$p.list.scrollable
    },
    // 值应为某子元素id（id不能以数字开头）
    scrollIntoView: {
      type: String,
      default: () => props$p.list.scrollIntoView
    },
    // 在设置滚动条位置时使用动画过渡
    scrollWithAnimation: {
      type: Boolean,
      default: () => props$p.list.scrollWithAnimation
    },
    // iOS点击顶部状态栏、安卓双击标题栏时，滚动条返回顶部，只对微信小程序有效
    enableBackToTop: {
      type: Boolean,
      default: () => props$p.list.enableBackToTop
    },
    // 列表的高度
    height: {
      type: [String, Number],
      default: () => props$p.list.height
    },
    // 列表宽度
    width: {
      type: [String, Number],
      default: () => props$p.list.width
    },
    // 列表前后预渲染的屏数，1代表一个屏幕的高度，1.5代表1个半屏幕高度
    preLoadScreen: {
      type: [String, Number],
      default: () => props$p.list.preLoadScreen
    },
    // 开启自定义下拉刷新
    refresherEnabled: {
      type: Boolean,
...
const props$a = defineMixin({
  props: {
    ...
    type: {
      type: String,
      default: () => props$p.tag.type
    },
    // 不可用
    disabled: {
      type: [Boolean, String],
      default: () => props$p.tag.disabled
    },
    // 标签的大小，large，medium，mini
    size: {
      type: String,
      default: () => props$p.tag.size
    },
    // tag的形状，circle（两边半圆形）, square（方形，带圆角）
    shape: {
      type: String,
      default: () => props$p.tag.shape
    },
    // 标签文字
    text: {
      type: [String, Number],
      default: () => props$p.tag.text
    },
    // 背景颜色，默认为空字符串，即不处理
    bgColor: {
      type: String,
      default: () => props$p.tag.bgColor
    },
    // 标签字体颜色，默认为空字符串，即不处理
    color: {
      type: String,
      default: () => props$p.tag.color
    },
    // 标签的边框颜色
    borderColor: {
      type: String,
      default: () => props$p.tag.borderColor
    },
    // 关闭按钮图标的颜色
    closeColor: {
      type: String,
      default: () => props$p.tag.closeColor
    },
    // 点击时返回的索引值，用于区分例遍的数组哪个元素被点击了
    name: {
      type: [String, Number],
      default: () => props$p.tag.name
    },
    ...
    plainFill: {
      type: Boolean,
      default: () => props$p.tag.plainFill
    },
    // 是否镂空
    plain: {
      type: Boolean,
      default: () => props$p.tag.plain
    },
    // 是否可关闭
    closable: {
      type: Boolean,
      default: () => props$p.tag.closable
    },
    // 是否显示
    show: {
      type: Boolean,
      default: () => props$p.tag.show
    },
    // 内置图标，或绝对路径的图片
    icon: {
      type: String,
      default: () => props$p.tag.icon
    },
    // 图标颜色
    iconColor: {
      type: String,
      default: () => props$p.tag.iconColor
    },
    // 自定义尺寸字体大小
    textSize: {
      type: String,
      default: () => props$p.tag.textSize
    },
    // 自定义尺寸高度
    height: {
      type: String,
      default: () => props$p.tag.height
    },
    // 自定义尺寸padding
    padding: {
      type: String,
      default: () => props$p.tag.padding
    },
    // 自定义尺寸
    borderRadius: {
      type: String,
      default: () => props$p.tag.borderRadius
    },
    // 自动计算背景色
    autoBgColor: {
      type: Number,
      default: () => props$p.tag.autoBgColor
    }
  }
});
...
const props$5 = defineMixin({
  props: {
    ...
    disabled: {
      type: Boolean,
      default: () => props$p.picker.disabled
    },
    disabledColor: {
      type: String,
      default: () => props$p.picker.disabledColor
    },
    placeholder: {
      type: String,
      default: () => props$p.picker.placeholder
    },
    // 是否展示picker弹窗
    show: {
      type: Boolean,
    ...
    valueName: {
      type: String,
      default: () => props$p.picker.valueName
    },
    // 是否允许点击遮罩关闭选择器
    closeOnClickOverlay: {
      type: Boolean,
...
const props = defineMixin({
  props: {
    ...
    height: {
      type: Number,
      default: () => props$p.statusBar.height
    }
  }
});
